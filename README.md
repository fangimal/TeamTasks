...
REST API сервис для управления задачами в командах. Текущий этап: кэширование списков задач через Redis.
