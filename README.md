...
REST API сервис для управления задачами в командах. Текущий этап: сложные SQL-запросы и оптимизация БД.
