...
REST API сервис для управления задачами в командах. Текущий этап: аутентификация и JWT-авторизация.

## Ожидаемый функционал

TeamTasks должен стать REST API для совместной работы над задачами внутри команд.

Планируемые возможности приложения:

- регистрация и вход пользователей;
- JWT-аутентификация и middleware авторизации;
- создание команд;
...
- проверка прав доступа к задачам и командам;
...
Текущее состояние проекта: реализована инфраструктура приложения, подключение к MySQL, миграции схемы БД, базовый слой Repository, проверка подключения к базе данных в `/health`, регистрация, логин и защищенный JWT middleware.
