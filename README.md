...
REST API сервис для управления задачами в командах. Текущий этап: база данных и базовый слой Repository.
...
Текущее состояние проекта: реализована инфраструктура приложения, подключение к MySQL, миграции схемы БД, базовый слой Repository и проверка подключения к базе данных в `/health`.
